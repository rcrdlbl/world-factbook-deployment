// https://github.com/d3/d3-geo-polygon v1.9.0 Copyright 2019 Mike Bostock
...
var DEFAULT_PLANAR_PROJECTION_RAW = d3Geo.geoAzimuthalEqualAreaRaw;
...
function complexLogRaw(planarProjectionRaw = DEFAULT_PLANAR_PROJECTION_RAW) {
  function forward(lambda, phi) {
    // Project on plane.
...
function complexLog(planarProjectionRaw = DEFAULT_PLANAR_PROJECTION_RAW, cutoffLatitude = DEFAULT_CUTOFF_LATITUDE) {
  var mutator = d3Geo.geoProjectionMutator(complexLogRaw);
...
exports.geoComplexLog = complexLog;
exports.geoComplexLogRaw = complexLogRaw;
